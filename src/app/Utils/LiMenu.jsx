...
function LiMenu(props) {
    const menuItems = [{name: 'Home'}, {name: 'About'}, {name: 'Cases'}, {name: 'Contact'}, {name: <Button text="Entrar em contato" animate={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 20 }} whileHover={{ scale: 1.02}} whileTap={{ scale: 0.90 }} className="w-42 rounded-full border border-slate-500 hover:border-blue-600  text-white font-normal px-12 py-3"/>}]
    return (
        <>
