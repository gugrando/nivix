...
const CasesSlide = () => {
    ...
    return (
        <>
            <motion.section ref={refGeral} className="overflow-x-clip h-[500vh] w-full p-8 bg-black">
                <motion.div className="lg:mt-40 mt-8 w-full flex flex-col items-center">
                    <motion.h1 className="md:text-6xl text-4xl text-center text-white font-bold">Deixe nossos projetos falarem por nós</motion.h1>
                ...
                <motion.div className=" h-[100vh] sticky top-0 flex items-center justify-start">
                    ...
                    <motion.div style={{x}} className="mt-8 flex gap-8 justify-center">                    
                        <Case logo={"src/assets/crafter.png"}/>
                        <Case/>
                        <Case/>
                        <Case/>
                        <Case/>
